...
#[cfg_attr(feature = "fuzzer-not-safe-for-production", derive(arbitrary::Arbitrary, Debug, Eq))]
...
#[derive(Copy, Clone)]
#[cfg_attr(feature = "fuzzer-not-safe-for-production", derive(arbitrary::Arbitrary, Debug, Eq, PartialEq))]
